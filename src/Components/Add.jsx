import { Tooltip, Fab, styled, Modal, Typography , Avatar, TextField, Stack, Button, ButtonGroup} from '@mui/material'
...
const Add = () => {
  ...
  return (
    ...
    <Box width={400} height={280} bgcolor={"background.default"} color={"text.primary"} p={3} borderRadius={5}>
      ...
      <UserBox>
        <Avatar
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQlElMnfFj3O55TvRbJC_KJnMqDNt3GeT9XckbBhXgM0g&s"
